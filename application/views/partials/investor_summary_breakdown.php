        ...
        <div class="summary_info">
            <div class="row">
                <div class="col-md-6 col-sm-6 text-right">
                    ...
                    <div class="text">
                        <?= i18n('x_invested', $user->username) ?> <strong><?= $invested_sum;?></strong> <?= i18n('credits'); ?>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-sm-offset-6 text-left">
                    ...
                    <div class="text">
                        <?= i18n('x_received', $participant->username) ?> <strong><?= $total_investment;?></strong> <?= i18n('credits'); ?>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-sm-6 col-sm-offset-6 text-left">
                    ...
                    <div class="text">
                        <?= i18n('x_returned', $participant->username) ?> <strong><?= $returned_sum;?></strong> <?= i18n('credits'); ?>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-sm-6 text-right breakdown">
                    ...
                    <?  $value = ($returned_sum - $invested_sum);
                        ...
                        <?= i18n('investor_breakdown', array($user->username, $invested_sum, $returned_sum, $value)); ?>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 text-left breakdown">
                    ...
                    <?  $value = ($total_investment - $returned_sum);
                        if ($value > 0) { $value = ' + '.$value; } ?>
                        <?= i18n('recipient_breakdown', array($participant->username, $total_investment, $returned_sum, $value)); ?>
                    </div>
                </div>
            </div>
